...
{
    public class SearchRelatedTests : IClassFixture<WebTestFixture>
    {
        ...
        public SearchRelatedTests(WebTestFixture factory)
        {
        ...
        public async Task TestCheckIfAddressSeededAsync()
        {
            ...
            response = await _client.GetAsync("/api/v1/Search/1");
            response.EnsureSuccessStatusCode();
