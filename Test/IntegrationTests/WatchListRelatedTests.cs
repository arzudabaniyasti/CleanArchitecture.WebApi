...
{
    public class WatchListRelatedTests : IClassFixture<WebTestFixture>
    {
        ...
        public WatchListRelatedTests(WebTestFixture factory)
        {
        ...
        public async Task TestCheckIfAddressSeededAsync()
        {
            ...
            response = await _client.GetAsync("/api/v1/WatchList/1");
            response.EnsureSuccessStatusCode();
