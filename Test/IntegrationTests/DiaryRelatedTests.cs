...
{
    public class DiaryRelatedTests : IClassFixture<WebTestFixture>
    {
        ...
        public DiaryRelatedTests(WebTestFixture factory)
        {
        ...
        public async Task TestCheckIfAddressSeededAsync()
        {
            ...
            response = await _client.GetAsync("/api/v1/Diary/1");
            response.EnsureSuccessStatusCode();
