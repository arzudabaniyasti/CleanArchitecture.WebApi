...
{
    public class WatchedListRelatedTests : IClassFixture<WebTestFixture>
    {
        ...
        public WatchedListRelatedTests(WebTestFixture factory)
        {
        ...
        public async Task TestCheckIfAddressSeededAsync()
        {
            ...
            response = await _client.GetAsync("/api/v1/WatchedList/1");
            response.EnsureSuccessStatusCode();
